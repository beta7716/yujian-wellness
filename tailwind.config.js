...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Modern medical-tourism palette inspired by international health sites
        teal: {
          50: "#f0fdf9",
          100: "#ccfbef",
          200: "#99f6e0",
        ...
        // Legacy palette preserved for existing components
        ink: {
          DEFAULT: "#1f2a2e",
          50: "#f6f6f4",
          100: "#e3e4e0",
      ...
      fontFamily: {
        // Modern sans-serif stack (no Google Fonts CORS dependency)
